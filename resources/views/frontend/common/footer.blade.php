			...
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="widget widget-contact mb-5 mb-lg-0">
					...
					<div class="footer-contact-block mb-4">
						...
						<h4 class="mt-2"><a href="tel:+23-345-67890">{{ $_SESSION['setting']->email ? $_SESSION['setting']->email :'' }}</a></h4>
					</div>
					...
					<div class="footer-contact-block">
						...
						<h4 class="mt-2"><a href="tel:+23-345-67890">{{ $_SESSION['setting']->phone ? $_SESSION['setting']->phone :'' }}</a></h4>
					</div>
				</div>
			</div>
		</div>
